...
```{r connect_to_spotify_api, include=FALSE}
library(spotifyr)
Sys.setenv(SPOTIFY_CLIENT_ID = "d180a8b2c34d4cc9bdece7c8f5de7d5a")
Sys.setenv(SPOTIFY_CLIENT_SECRET = "4cdfdc376ce843e8a39524e6fb29d33e")
